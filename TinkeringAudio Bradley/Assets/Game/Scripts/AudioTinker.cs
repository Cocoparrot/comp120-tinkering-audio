...
public class AudioTinker : MonoBehaviour {
    ...
    public int soundFrequency {
        get { return _soundFrequency; }
        set {
            PlayOutAudio();
            _soundFrequency = value;
        }
    }
    ...
    public void PlayOutAudio() {
        /* Recreate audioclip every time we play it so we can visualize changes quicky*/
        outAudioClip = CreateToneAudioClip(soundFrequency);
